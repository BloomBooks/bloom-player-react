...
export const BloomPlayerControls: React.FunctionComponent<IProps &
    ...
    const handleStartImageDescription = (element: HTMLElement) => {
        setNowReadingImageDescription(true);
    };

    const handleStopImageDescription = () => {
        setNowReadingImageDescription(false);
    };
    ...
    return (
        ...
        >
            ...
            <BloomPlayerCore
                ...
                startImageDescriptionCallback={handleStartImageDescription}
                stopImageDescriptionCallback={handleStopImageDescription}
            />
        </div>
    );
};
