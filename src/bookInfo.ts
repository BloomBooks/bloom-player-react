...
export class BookInfo {
    ...
    public getAmbientAnalyticsProps(): any {
        ...
        if (this.publisher) {
            ambientAnalyticsProps.publisher = this.publisher;
        }
        if (this.originalPublisher) {
            ambientAnalyticsProps.originalPublisher = this.originalPublisher;
        }
        return ambientAnalyticsProps;
    }
