...
export default class WidgetTestActivity {
    ...
    start(activityContext) {
        ...
        this.activityContext.sendHideButtonsMessage();
        this.button1.onclick = () => this.activityContext.sendForwardMessage();
        this.button2.onclick = () => this.activityContext.sendBackwardMessage();
    }
