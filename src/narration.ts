...
export default class Narration {
    ...
    private _includeImgDesc: boolean = true;
    public set includeImageDescriptions(includeImageDescriptions: boolean) {
        this._includeImgDesc = includeImageDescriptions;
    }
