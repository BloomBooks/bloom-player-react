...
export class BloomPlayerCore extends React.Component<IProps, IState> {
    ...
    // That allows for it to be a LOT slower on a phone with a poor
    // connection (though we don't expect most activities to actually involve the
    // internet...they should be designed to work offline).
    ...
    public render() {
        ...
        const swiperParams: any = {
            ...
            on: {
                ...
                // connection (though we don't expect most activities to actually involve the
                // internet...they should be designed to work offline). We want SOME limit so
