...
export class BloomPlayerCore extends React.Component<IProps, IState> {
    ...
    private indexOflastNumberedPageWasRead: number;
            ...
            axios.get(urlOfBookHtmlFile).then(result => {
                ...
                const finishUp = () => {
                    ...
                    for (let i = 0; i < pages.length; i++) {
                        ...
                        if (hasPageNum) {
                            this.indexOflastNumberedPageWasRead =
                    ...
                    const talkingBook =
                        bookHtmlElement.ownerDocument!.evaluate(
                            ...
                            body,
                            null,
                            XPathResult.ANY_UNORDERED_NODE_TYPE, //just want to know whether it occurs
                            null
    ...
    private showingPage(index: number): void {
        ...
        reportPageShown(
            pageHasAudio,
            index === this.indexOflastNumberedPageWasRead
        );
    }
}
